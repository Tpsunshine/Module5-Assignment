...
public class HashTable_Student {
	...
	public static void main(String[] args) {
		...
		student s1 = new student(1, "John Curry", 98);
		student s2 = new student(2, "Maria Ramos", 65);
		student s3 = new student(3, "Bill Clinton", 98);
		student s4 = new student(4, "Bill Gates", 99);
		student s5 = new student(5, "Steve Jobs", 80);
